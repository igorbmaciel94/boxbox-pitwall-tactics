...
const MENU_ITEMS = [
  ...
  { labelKey: 'home.menu.seasonLabel', descKey: 'home.menu.seasonDesc', path: '/season', icon: '\u{1F3C6}', accent: 'text-apex-red', needsDeck: true, isSeason: true, isQuickRace: false },
